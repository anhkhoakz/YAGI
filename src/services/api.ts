 ...
 */
export const fetchTemplates = async (customApiEndpoint: string | null): Promise<string[]> => {
    ...
    try {
        ...
        throw new Error(`Failed to fetch templates from ${endpoint}: ${getErrorMessage(error)}`);
    }
};
